...
import katalog_image from '../../images/katalog-button.svg'
            ...
            <div className="nav-container">
                ...
                <div id='search_container' className="search_div_big_container">
                    ...
                    <div ref={historyDivRef} className="search-div">
                        <input id='SearchBox' onKeyDown={(e) =>{if (e.key === 'Enter'){setOpenSearch(false);SearchQuery(); e.target.value = ''}}}  className='search-input' type="search" placeholder= 'Найти товары' onClick={() => setOpenSearch(true)} />
                        <button className='search-katalog-button' onClick={() => props.open()} title='Katalog'><img src={props.katalog ? close_icon : katalog_image} alt="katalog" />  Каталог</button>
                        <img src={search_icon} alt="search-icon" className='search-icon' onClick={ SearchQuery } />
